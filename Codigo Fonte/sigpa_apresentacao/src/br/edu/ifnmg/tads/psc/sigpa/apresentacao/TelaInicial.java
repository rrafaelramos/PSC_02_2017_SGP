...
public class TelaInicial extends javax.swing.JFrame {
    ...
    void habilitaAdministrador() {
        jMAdm.setEnabled(true);
        jMVendedor.setEnabled(false);
        
    }

    void habilitaVendedor() {
        jMAdm.setEnabled(false);
        jMVendedor.setEnabled(true);
    }
}
